...
import type { DocumentIR, FigureRecord, QuestionBankRepository, QuestionObject, QuestionSearchQuery } from "../../src/modules/question-bank/types.js";
import {
  safeCleanDocx,
...
export class TeacherWorkflowService {
  protected lastCanonicalDocument?: DocumentIR;
  ...
  async importDocxForRuntime(
    ...
    this.lastCanonicalDocument = result.document;
