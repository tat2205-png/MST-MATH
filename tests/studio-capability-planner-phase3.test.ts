...
assert.throws(() => validateStudioTaskRequest({ task: "math.solve", input: { text: "2x-4=0" }, requestedCapabilities: ["geometry.2d"] }));
assert.throws(() => validateStudioTaskRequest({ task: "math.solve", input: { text: "2x-4=0", path: "C:\\unsafe" }, requestedCapabilities: ["math.solve"] }));
