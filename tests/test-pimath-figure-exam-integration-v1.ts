...
import { proposeFigureReconstruction } from "../src/modules/figure-reconstruction/index.js";
...
const figure = { ...proposal.contract, boundingBox: { x: 10, y: 20, width: 240, height: 160, unit: "pt" as const }, safeBoundingBox: { x: 18, y: 28, width: 224, height: 144, unit: "pt" as const }, placement: { preferredRegion: "ABOVE" as const, keepWithQuestion: true } };
