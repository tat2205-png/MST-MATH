...
export function createQuestionDocx(): Uint8Array {
  ...
  <w:tbl><w:tr><w:tc><w:p><w:r><w:t>a) Hàm số xác định trên ℝ</w:t></w:r></w:p></w:tc><w:tc><w:p><w:r><w:t>b) Hàm số luôn âm</w:t></w:r></w:p></w:tc></w:tr></w:tbl>
  <w:p><w:pPr><w:pStyle w:val="Heading1"/></w:pPr><w:r><w:t>PHẦN III. TỰ LUẬN</w:t></w:r></w:p>
  <w:p><w:r><w:b/><w:t>Bài 3) Cho tam giác ABC. a) Chứng minh hệ thức. b) Tính độ dài.</w:t></w:r></w:p>
  </w:body></w:document>`;
  const rels = `<Relationships><Relationship Id="rId1" Target="media/figure1.png" Type="image"/></Relationships>`;
  return zipSync({ "word/document.xml": enc.encode(document), "word/_rels/document.xml.rels": enc.encode(rels), "word/media/figure1.png": new Uint8Array([137,80,78,71]), "word/media/orphan.png": new Uint8Array([137,80,78,71,1]) });
}
