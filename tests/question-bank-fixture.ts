...
export function createQuestionDocx(): Uint8Array {
  ...
  const rootRels = `<?xml version="1.0" encoding="UTF-8"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rIdDocument" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="word/document.xml"/></Relationships>`;
  return zipSync({ "[Content_Types].xml": enc.encode(contentTypes), "_rels/.rels": enc.encode(rootRels), "word/document.xml": enc.encode(document), "word/_rels/document.xml.rels": enc.encode(rels), "word/media/figure1.png": new Uint8Array([137,80,78,71]), "word/media/figure2.svg": enc.encode("<svg/>"), "word/media/orphan.png": new Uint8Array([137,80,78,71,1]) });
}