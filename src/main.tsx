...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    {isDynamicGeometryViewer ? <Suspense fallback={<div>Loading Dynamic Geometry…</div>}><DynamicGeometryDevPanel onExit={()=>window.location.assign('/')} /></Suspense> : isFoldViewer ? <Suspense fallback={<div>Loading Fold 3D viewer…</div>}><Fold3DViewer /></Suspense> : <App />}
  </StrictMode>,
);
