...
import { resolveConsumerProfile } from "./mstMathBrandRoot.js";
...
export const MST_MATH_FOLD_OUTPUT_PROFILE = resolveConsumerProfile("FOLD");
/** @deprecated Compatibility alias for pre-MST-MATH callers. */
export const PIMATH_FOLD_OUTPUT_PROFILE = MST_MATH_FOLD_OUTPUT_PROFILE;
