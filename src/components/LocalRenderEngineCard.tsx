...
export const LocalRenderEngineCard: React.FC = () => {
  ...
  const isAutoRepairEnabled =
    ...
    hasSafeIssues &&
    frameQAReport?.qaMetrics.frameInputQa !== "FAIL" &&
    !isRepairing;
                ...
                {smokeReport.artifacts.map((art) => (
                  ...
                  >
                    <div className="flex items-center space-x-2 truncate">
                      {art.previewDataUrl ? (
                        <img src={art.previewDataUrl} alt={art.name} className="w-12 h-8 object-contain rounded border border-slate-300 bg-slate-900 shrink-0" />
