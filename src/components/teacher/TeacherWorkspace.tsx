...
export function QuestionCard({ question, selected, onToggle, review, analysis, onAnalyze }: { question: TeacherQuestion; selected?: boolean; onToggle?: () => void; review?: boolean; analysis?: ExamAnalysisView; onAnalyze?: () => void; key?: React.Key }) {
