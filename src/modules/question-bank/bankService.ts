...
import { ingestDocxQuestions } from "./pipeline.js";
...
export class QuestionBankService {
  ...
  importDocx(bytes: Uint8Array, name: string): BankImportResult {
    ...
    const snapshot: QuestionBankSnapshot = { schemaVersion: 1, questions, orphanFigures }; this.repository.replace(snapshot); return { imported, duplicates, diagnostics, snapshot: this.repository.load() };
  }
}
