// FOLD-domain GeoGebra V3 adapter.
// Consumes generic GeoGebra runtime; does not own mathematical authority.

import { createGeoGebraOriginGuard, type GeoGebraFoldApi } from "../../geogebra/runtime.js";
import { V3_FOLD_MODEL } from "../v3-fold-model.js";
import { createSquareSheetRegularSquareFrustum } from "../canonical-frustum-fixture.js";
