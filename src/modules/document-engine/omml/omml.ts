...
function convertNode(node: XmlNode, issues: DocumentEngineIssue[], path: string): string {
  ...
  switch (name) {
    ...
    case "ctrlPr": case "rPr": case "fPr": case "radPr": case "sSupPr": case "sSubPr": case "sSubSupPr": case "dPr": case "oMathParaPr": case "oMathPr": case "naryPr": case "limLowPr": case "mPr":
      return "";
    case "bookmarkStart": case "bookmarkEnd": case "eqArr": case "eqArrPr":
      return convertChildren(node, issues, path);
    default:
