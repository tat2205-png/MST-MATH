...
export type FrameQARepairClass = "SAFE_AUTO_REPAIR" | "REVIEW_REQUIRED";
...
export interface JobVisualFrameQAReport {
  ...
  qaMetrics: {
    ...
    geminiVisionQa: "PASS" | "FAIL";
    startVisualQa: "PASS" | "FAIL";
    keyVisualQa: "PASS" | "FAIL";
    endVisualQa: "PASS" | "FAIL";
